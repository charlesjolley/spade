...
/** @class
  ...
  {{{
    SC.ArrayTests = SC.Suite.create("Verify SC.Array compliance", {
...
*/
SC.Suite = /** @scope SC.Suite.prototype */ {
  ...
  /**
    ...
    @returns {SC.Suite} subclass of suite.
  */
  ...
  /**
    ...
    @param {Hash} attrs one or more attribute hashes
    @returns {SC.Suite} suite instance
  */
