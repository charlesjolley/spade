...
// For now. fake jQuery if it is not installed.
...
if ('undefined'===typeof sc_require) sc_require = K;
if ('undefined' === typeof sc_resource) sc_resource = K;
...
if ('undefined' === typeof SproutCore) SproutCore = SC ;
