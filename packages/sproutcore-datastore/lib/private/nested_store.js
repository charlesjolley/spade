...
/** @scope SC.NestedStore.prototype */ {
  ...
  */
  ...
  readEditableDataHash: function(storeKey) {
    ...
    return this.superclass(storeKey);
  },
  
  /** @private - adds chaining support - 
    Does not call superclass because the implementation of the method vary too
    much. 
  */
  ...
  removeDataHash: function(storeKey, status) {
    ...
    return this.superclass(storeKey, status);
  },
  ...
  commitChangesFromNestedStore: function(nestedStore, changes, force) {
    ...
    this.superclass(nestedStore, changes, force);
